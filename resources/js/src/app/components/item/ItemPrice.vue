<template>
  <div :class="{ 'has-crossprice': hasCrossPrice }" class="d-flex flex-row-reverse justify-content-end py-3">
    <div class="crossprice h3 mx-4" v-if="showCrossPrice && hasCrossPrice"
         :class="{ 'is-special-offer': hasSpecialOffer }">
      <del>
